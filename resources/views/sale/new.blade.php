		                            ...
		                            <div class="row">
		                                <div class="col-md-12">
		                                    <fieldset>
	                                            ...
	                                            <select class="form-control" name="client" id="client">
						                            ...
						                            @foreach($clients as $client)
						                                <option value="{{ $client->client_cli }}">
						                                    {{ $client->name_cli }}
						                                </option>
						                            @endforeach
						                        </select>
		                                    ...
		                                    <fieldset>
	                                        	...
	                                        	<input type="date" class="form-control" name="date" placeholder="Fecha de Venta">
		                                    </fieldset>
		                                    <br>
   	...
   	$.ajax({
        ...
        success:function(data){
        	$('#body_table').prepend(`<tr>
                ...
                <td class="sorting_1">
                    <input type="number" class="form-control stock_prod NAN" max="${data.stock_prod}" value="1" name="quantity[]">
                </td>
