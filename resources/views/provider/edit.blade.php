	        ...
	        <div class="col-md-12">
	            <div class="card">
	                ...
	                <div class="card-content collapse show">
	                    <div class="card-body">
	                        <form class="form form-horizontal row-separator" action="{{ route('update.provider',$provider->provider_id) }}" method="POST">
	                        	@csrf
	                        	@method('PUT')
	                            <div class="form-body">
	                                ...
	                                <div class="row">
	                                    <div class="col-md-4">
	                                        <div class="form-group row mx-auto">
	                                            ...
	                                            <div class="col-md-9">
	                                                <input type="text" id="userinput1" class="form-control border-primary" value="{{ $provider->company_name }}" placeholder="Ingresar nombre de la Empresa" name="company_name">
	                                            </div>
	                                        </div>
	                                    </div>
	                                    <div class="col-md-4">
	                                        <div class="form-group row mx-auto">
	                                            ...
	                                            <div class="col-md-9">
	                                                <input type="text" id="userinput2" class="form-control border-primary" value="{{ $provider->nit }}"placeholder="Ingresar NIT" name="nit">
	                                            </div>
	                                        </div>
	                                    </div>
	                                    <div class="col-md-4">
	                                        <div class="form-group row mx-auto">
	                                            ...
	                                            <div class="col-md-9">
	                                                <input type="text" id="userinput2" class="form-control border-primary" value="{{ $provider->address }}"placeholder="Ingresar Dirección" name="address">
	                                            </div>
	                                        </div>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="row">
	                                    <div class="col-md-4">
	                                        <div class="form-group row mx-auto">
	                                            ...
	                                            <div class="col-md-9">
	                                                <input type="text" id="userinput1" class="form-control border-primary" value="{{ $provider->name_manager }}"placeholder="Ingresar nombre del Encargado" name="name_manager">
	                                            </div>
	                                        </div>
	                                    </div>
	                                    <div class="col-md-4">
	                                        <div class="form-group row mx-auto">
	                                            ...
	                                            <div class="col-md-9">
	                                                <input type="text" id="userinput2" class="form-control border-primary" value="{{ $provider->phone }}"placeholder="Ingresar número de telefono" name="phone">
	                                            </div>
	                                        </div>
	                                    </div>
	                                    <div class="col-md-4">
	                                        <div class="form-group row mx-auto">
	                                            ...
	                                            <div class="col-md-9">
	                                                <input type="text" id="userinput2" class="form-control border-primary" value="{{ $provider->email }}"placeholder="Ingresar Email" name="email">
	                                            </div>
	                                        </div>
	                                    </div>
	                                </div>
