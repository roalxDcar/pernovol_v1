	        ...
	        <div class="col-md-12">
	            <div class="card">
	                ...
	                <div class="card-content collapse show">
	                    <div class="card-body">
	                        <form class="form form-horizontal row-separator" action="{{ route('store.category') }}" method="POST">
	                        	@csrf
	                            <div class="form-body">
	                                ...
	                                <div class="row">
	                                    <div class="col-md-12">
	                                        <div class="form-group row mx-auto">
	                                            ...
	                                            <div class="col-md-10">
	                                                <input type="text" id="userinput1" class="form-control border-primary" placeholder="Ingresar Descripción" name="name_cat">
	                                            </div>
	                                        </div>
	                                    </div>
	                                </div>
